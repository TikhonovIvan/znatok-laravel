...
@section('content')
    ...
    <div class="gridarea__2 sp_bottom_100" data-aos="fade-up">
        <div class="container">
            ...
            <div class="section__title">
                <div class="section__title__button">
                    <div class="default__small__button">Популярные курсы</div>
                </div>
                <div class="section__title__heading">
                    <h2>Выберите лучший пакет
                        <br>для вашего обучения</h2>
                </div>
            </div>
                    ...
                    <div class="gridarea__wraper card-container"  style="height: 460px;">
                        ...
                        <div class="gridarea__content card-content">
                            ...
                            <div class="gridarea__heading">
                                <h3><a href="course-details.html">Foundation course to under stand about softwere</a></h3>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class">
                    <div class="gridarea__wraper card-container"  style="height: 460px;">
                        ...
                        <div class="gridarea__content card-content">
                            ...
                            <div class="gridarea__heading">
                                <h3><a href="course-details.html">Дизайн и дизайн</a></h3>
                            </div>
