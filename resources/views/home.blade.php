...
@section('title', 'Главная | Znatok-KG ')

@section('content')

    <!-- Образовательное решение__start -->
    <div class="herobannerarea herobannerarea__2">
                ...
                >
                    <div class="aboutarea__img__2" data-tilt>
                        <img
                            loading="lazy"
                            class="aboutimg__1"
                            src="{{asset('assets/img/about/about_10.png')}}"
                            alt="aboutimg"
                        />
                    </div>
                </div>
        ...
        <div class="herobannerarea__icon__2">
            ...
            <img
                ...
                src="{{asset('assets/img/herobanner/herobanner__4.png')}}"
                alt="photo"
            />
            <img
                loading="lazy"
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="about__right__wraper__2">
                        <div class="educationarea__img" data-tilt>
                            <img loading="lazy"  class="aboutarea__2__img__1" src="{{asset('assets/img/about/about_2.png')}}" alt="education">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    ...
                    <div class="aboutarea__content__wraper">
                        ...
                        <div class="aboutarea__list__2">
                            <ul>
                                <li>
                                    <i class="icofont-check"></i> Простота и удобство
                                </li>

                                <li>
                                    <i class="icofont-check"></i> Исследуйте множество новых образовательных программ
                                </li>

                                <li>
                                    <i class="icofont-check"></i> Большой выбор курсов
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row populerarea__wraper">
                ...
                <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="populerarea__content">
                        <p>
                            Большой выбор различных обраховательных курсов на разные направления.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Бизнес-исследования</a></h3>
                            <p>Бизнес успешен</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                                class="icon__hover__img"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <path
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Технология программирования</a></h3>
                            <p>обновить свой навык</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                                class="icon__hover__img"
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Художник и <br> Дизайн</a></h3>
                            <p>проявите креативность</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                                class="icon__hover__img"
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Машинное обучение</a></h3>
                            <p>Возможности ИИ</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Наука и исследования </a></h3>
                            <p>Наука - это сила</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Здоровье и фитнес</a></h3>
                            <p>здоровье - это богатство</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                                class="icon__hover__img"
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Маркетинговый анализ</a></h3>
                            <p>Маркетинг - это просто</p>
                        </div>
                        <div class="service__small__img">
                            <svg
                                class="icon__hover__img"
    ...
    <!-- Популярные тему курсов__end -->

    <!-- Список курсов__start -->
            ...
            <div class="row grid__row">
                ...
                >
                    <div class="section__title__2">
                        ...
                        <div
                            class="section__title__heading__2 section__title__heading__3 heading__fontsize__2"
                        >
                            <h2 class="fs-2">Идеальный онлайн-курс для вашей карьеры</h2>
                        </div>
                    </div>
                </div>
                <div
                ...
                >
                    <div class="gridfilter_nav grid__filter__2 gridFilter">
                        ...
                        <button data-filter=".filter1" class="">Наука о данных</button>
                        <button data-filter=".filter2" class="">Инженерное дело</button>
                        <button data-filter=".filter3" class="">Программирование</button>
                ...
                <div class="col-xl-12" data-aos="fade-up">
                    <div class="section__title__2 text-center teamarea__margin">
                        <div class="section__small__title">
                            <span>Опытный учитель</span>
                        </div>
                        <div
                            class="section__title__heading__2 section__title__heading__3 heading__fontsize__2"
                        >
                            <h2>Наш опытный преподаватель</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                >
                    <div class="single__team">
                        ...
                        <div class="teamarea__content">
                            <p>Художник</p>
                            <h5><a href="#">Саджид Мустахидул</a></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12" data-aos="fade-up">
                    <div class="section__title__2 text-center teamarea__margin">
                        ...
                        <div
                            class="section__title__heading__2 section__title__heading__3 heading__fontsize__2"
                        >
                            <h2>Последние новости и блоги</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                >
                    <div class="single__blog__wraper">
                        ...
                        <div class="single__blog__content">
                            <p>13 января 2025 г.</p>
                            <h4>
                                <a href="#"
                                >Facebook Design посвящен новинкам в дизайне
                                </a>
                            </h4>
                ...
                <div class="col-xl-12" data-aos="fade-up">
                    <div class="blogarea__bottom__button">
                        <a class="default__button" href="#">БОЛЬШЕ БЛОГА</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <!-- Новости_или_блог__end -->
