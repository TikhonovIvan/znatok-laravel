...
<div class="footerarea">
    <div class="container">
                ...
                >
                    <div class="footerarea__inner footerarea__about__us">
                        ...
                        <div class="footerarea__content">
                            <p>
                                Мы предлагаем лучше решение для вашего будущего
                            </p>
                        </div>
                ...
                >
                    <div class="footerarea__inner footerarea__padding__left">
                        ...
                        <div class="footerarea__list">
                            <ul>
                                <li>
                                    <a href="#">Дизайн пользовательского интерфейса</a>
                                </li>
                                <li>
                                    <a href="#">Веб-разработка</a>
                                </li>
                                <li>
                                    <a href="#">Бизнес-стратегия</a>
                                </li>
                                <li>
                                    <a href="#">Разработка программного обеспечения</a>
                                </li>
                                <li>
                                    <a href="#">Деловой английский</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        >
            <div class="row">
                <div class="col-xl-3 col-lg-3 d-none">
                ...
                <div class="col-xl-12 col-lg-12 text-center">
                    ...
                    >
                        <p>
                            Копирайт© <span>2025</span> все права защищены.
                        </p>
                    </div>
                </div>
