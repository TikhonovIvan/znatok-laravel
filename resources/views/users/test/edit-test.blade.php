...
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="breadcrumb__content__wraper" data-aos="fade-up">
                        <div class="breadcrumb__title">
                            <h2 class="heading">Редактирование теста</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="create__course sp_100">
        <div class="container">
            <form action="{{route('course.test.update', $test->id)}}" method="post">
                @csrf
                @method('PUT')
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <h2 class="">Редактировать тест</h2>
                                    </h2>
                                    <div
                                        id="collapseOne"
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                                <div class="create__course__bottom__button">
                                    <button type="submit" class="create__course__bottom__button_top">Редактировать тест</button>
                                </div>
                            </div>
                        </div>
                    </div>
