...
@section('title', 'Редактировать курс | Znatok-KG ')
                ...
                <div class="col-xl-12">
                    <div class="breadcrumb__content__wraper" data-aos="fade-up">
                        <div class="breadcrumb__title">
                            <h2 class="heading">Редактировать курс</h2>
                        </div>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        >
                                                            ...
                                                            <div class="dashboard__selector">
                                                                <select name="category" class="form-select" aria-label="Default select example">
                                                                    ...
                                                                    <option value="Веб дизайн" {{ $course->category == 'Веб дизайн' ? 'selected' : '' }}>Веб дизайн</option>
                                                                    <option value="Компьютерная графика" {{ $course->category == 'Компьютерная графика' ? 'selected' : '' }}>Компьютерная графика</option>
                                                                    <option value="Программирование" {{ $course->category == 'Программирование' ? 'selected' : '' }}>Программирование</option>
                                                                    <option value="Английский" {{ $course->category == 'Английский' ? 'selected' : '' }}>Английский</option>
                                                                    <option value="Наука" {{ $course->category == 'Наука' ? 'selected' : '' }}>Наука</option>
                                                                    <option value="Медицина" {{ $course->category == 'Медицина' ? 'selected' : '' }}>Медицина</option>
                                                                    <option value="Робототехника" {{ $course->category == 'Робототехника' ? 'selected' : '' }}>Робототехника</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                                        <div class="mb-4">
                                                            ...
                                                            @php
                                                                $status = old('status', $course->status ?? 'draft'); // если отправляли форму с ошибками — возьмется old, иначе статус из БД
                                                            @endphp

                                                            <div class="d-flex gap-5 flex-wrap">
                                                                <label class="dashboard__form__input d-flex align-items-center gap-2">
                                                                    <input
                                                                        type="radio"
                                                                        name="status"
                                                                        value="draft"
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                                <div class="create__course__bottom__button">
                                    <button class="create__course__bottom__button_top"  type="submit" >Обновить курс</button>
                                </div>
                            </div>
                        </div>
                    </div>
