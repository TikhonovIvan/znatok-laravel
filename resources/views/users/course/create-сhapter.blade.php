...
@section('content')
    ...
    <div class="create__course sp_100">
        <div class="container">
            <form action="{{route('course.store-chapter',$courseId )}}" method="post">
                @csrf
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                                        <div class="dashboard__form__wraper">
                                                            <div class="dashboard__form__input">
                                                                ...
                                                                <input type="text" name="title" placeholder="Раздел 1: Введение в дизайн">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                                <div class="create__course__bottom__button">
                                    <button class="create__course__bottom__button_top" type="submit">Создать раздел</button>
                                </div>
                            </div>
                        </div>
                    </div>
