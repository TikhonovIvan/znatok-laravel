...
@section('title', 'Редактировать данные | Znatok-KG ')
        ...
        <div class="dashboard__content__wraper">
            ...
            <div class="row">
                    ...
                    <ul class="nav  about__button__wrap dashboard__button__wrap" id="myTab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="single__tab__link" data-bs-toggle="tab"
                                    ...
                                    role="tab" tabindex="-1">Пароль
                            </button>
                        </li>
                        <li class="nav-item d-none" role="presentation ">
                            <button class="single__tab__link" data-bs-toggle="tab"
                                    data-bs-target="#projects__three" type="button"
                                    aria-selected="false" role="tab" tabindex="-1">Social Icon
                            </button>
                        </li>
                ...
                <div class="tab-content tab__content__wrapper aos-init aos-animate"
                                        ...
                                        <div class="col-xl-12">
                                            <div class="dashboard__form__wraper">
                                                <div class="dashboard__form__input">
                                                    ...
                                                    <textarea name="bio" id="bio__text" cols="30"
                                                              rows="10"
                                                              placeholder="Введите текст">{{$user->bio}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="dashboard__form__button">
                                                <button type="submit" class="default__button">Обновить данные</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <form action="{{route('password.update')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="dashboard__form__wraper">
                                        <div class="dashboard__form__input">
                                            <label>Стрый пароль</label>
                                            <input type="password" name="current_password"  placeholder="Старый пароль">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="dashboard__form__button">
                                        <button type="submit" class="default__button">Обновить пароль</button>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade d-none" id="projects__three" role="tabpanel"
